...
import { FaArrowLeft, FaBox, FaTruck, FaMapMarkerAlt, FaCreditCard, FaTag, FaCheckCircle } from "react-icons/fa";
...
export default async function OrderDetailsPage({ params }: Props) {
    ...
    const shippingFee = order.shippingFee !== undefined ? order.shippingFee : (parseFloat(order.totalAmount) > 100 ? 0 : 10);
    ...
    return (
        <UserDashboardShell>
            ...
            <div className="flex items-center gap-4 mb-8">
                <Link href="/dashboard/orders" className="p-3 bg-white border border-slate-200 rounded-full text-slate-500 hover:text-slate-900 hover:bg-slate-50 transition-colors cursor-pointer shadow-sm">
                    <FaArrowLeft size={16} />
                </Link>
                <div>
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="lg:w-2/3 space-y-6">
                    <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
                        ...
                        {/* ACCURATE FINANCIAL SUMMARY WITH COUPON DISPLAY */}
